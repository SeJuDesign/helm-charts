...
This example deploy a 3 nodes Elasticsearch 7.13.5-snapshot cluster on [Minikube][]
using [custom values][].
...
[custom values]: https://github.com/elastic/helm-charts/tree/7.13/elasticsearch/examples/minikube/values.yaml
