...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=7.14.0-snapshot`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=7.14.0-snapshot`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `7.14.0-snapshot`                    |
