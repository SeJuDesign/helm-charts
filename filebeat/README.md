...
* Install it:
  - with Helm 3: `helm install filebeat ./helm-charts/filebeat --set imageTag=7.13.5-snapshot`
  - with Helm 2 (deprecated): `helm install --name filebeat ./helm-charts/filebeat --set imageTag=7.13.5-snapshot`
...
| `imageTag`                     | The filebeat Docker image tag                                                                                                                                                | `7.13.5-snapshot`                  |
...
[examples]: https://github.com/elastic/helm-charts/tree/7.13/filebeat/examples
[examples/oss]: https://github.com/elastic/helm-charts/tree/7.13/filebeat/examples/oss
[examples/security]: https://github.com/elastic/helm-charts/tree/7.13/filebeat/examples/security
[filebeat docker image]: https://www.elastic.co/guide/en/beats/filebeat/7.13/running-on-docker.html
[filebeat oss docker image]: https://www.docker.elastic.co/r/beats/filebeat-oss
[filebeat outputs]: https://www.elastic.co/guide/en/beats/filebeat/7.13/configuring-output.html
[helm]: https://helm.sh
...
[kafka output]: https://www.elastic.co/guide/en/beats/filebeat/7.13/kafka-output.html
...
[values.yaml]: https://github.com/elastic/helm-charts/tree/7.13/filebeat/values.yaml
