...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=7.13.5-snapshot`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=7.13.5-snapshot`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `7.13.5-snapshot`                  |
